...
<div tabindex="0" role="button" on:keypress={closeDetail}
     class="w-screen h-screen bg-gray-100/10 backdrop-blur-md z-50 fixed top-0 left-0 cursor-default" on:click={closeDetail}
