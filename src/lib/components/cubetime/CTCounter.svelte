...
<style>
    button {
        @apply px-4 flex justify-center items-center bg-gray-300 hover:brightness-90 transition-all duration-300 ease-in-out w-full h-full;
    }

    button:disabled {
        @apply hover:brightness-100 opacity-50;
    }
</style>
